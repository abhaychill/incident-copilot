...
export async function chatWithRunbook(incident, messages, runbookText = '') {
...
export async function generateReport(incident, chatHistory) {
...
## ✅ Action Items
[5 concrete action items to prevent recurrence, each with an owner role]
